    ...
    const callbackH = function (mutationsList, observer) {
        mutationsList.forEach(mutation => {
            if (mutation.type === 'attributes' && mutation.attributeName === 'class') {
                ...
                parentContainerH.style.boxSizing = 'border-box';
                parentContainerH.style.mozBoxSizing = 'border-box';
                parentContainerH.style.webkitBoxSizing = 'border-box';
                parentContainerH.style.border = '2.5px solid transparent';
                ...
                if (targetLabelH.classList.contains('q-checked')) {
                    ...
                    if (targetLabelH.classList.contains('q-focused')) {
                        parentContainerH.style.borderColor = '#0B6ED0';
                        parentContainerH.style.outlineOffset = '-1px';
                        // parentContainerH.style.webkitBoxShadow = 'inset 0px 0px 0px 2px #0B6ED0';
                        // parentContainerH.style.mozBoxShadow = 'inset 0px 0px 0px 2px #0B6ED0';
                        // parentContainerH.style.boxShadow = 'inset 0px 0px 0px 2px #0B6ED0';
                        
                    } else {
                        parentContainerH.style.borderColor = 'transparent';
                        // parentContainerH.style.webkitBoxShadow = 'inset 0px 0px 0px 2px transparent';
                        // parentContainerH.style.mozBoxShadow = 'inset 0px 0px 0px 2px transparent';
                        // parentContainerH.style.boxShadow = 'inset 0px 0px 0px 2px transparent';
                    };
                } else {
